...
# inv
from inv.api.router import router_category, router_product, router_uom, router_warehouse, router_location, router_brand, router_model
...
urlpatterns = [
    ...
    path('api/', include(router_model.urls)),
